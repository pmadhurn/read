...
| Blink aids (user request 2026-09-24): faint trail of the last five words under the ORP line; blink breaks — a dimmed 450 ms beat at the next sentence end every 5/10/20 s; replay-sentence while playing (Left arrow, Backspace, R, ⏪ or a tap on the left edge) that eases back in with the ramp-up. | done | `tests/blink.mjs` (7 checks) |
